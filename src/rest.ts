...
export interface RequestWithContractQuerystring extends RequestGenericInterface {
  Querystring: {
...
export type GetAccountAssetsRequest = RequestWithChainIdQuerystring & RequestWithAddressQuerystring;

export type GetAccountTransactionsRequest = RequestWithChainIdQuerystring &
  RequestWithAddressQuerystring;

export type GetAccountNonceRequest = RequestWithChainIdQuerystring & RequestWithAddressQuerystring;
...
export type PostRpcRequest = RequestWithJsonRpcBody & RequestWithChainIdQuerystring;
